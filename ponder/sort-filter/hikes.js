...
searchInput.addEventListener("click", e => {
    ...
    const filteredHikes = hikes.filter(hike => {
        ...
        hike.tags.some(tag => tag.toLowerCase().includes(userInput))
    });
    console.log("Filtered Hikes: ", filteredHikes);

    let sortedHikes = filteredHikes.sort(sortByDifficulty);
    function sortByDifficulty(hikea, hikeb) {
    ...
    console.log("Sorted Hikes: ", sortedHikes);
