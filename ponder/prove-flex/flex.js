...
searchButton.addEventListener('click', () => {
    ...
    console.log("Filtered Recipes: ", filteredCards);

    let sortedRecipes = filteredCards.sort(sortByRating);
    function sortByRating(recipea, recipeb) {
...
let recipesContainer = document.getElementsByClassName('recipe-card')[0];
...
function recipeTemplate(recipe) {
    ...
    <div class="recipe-details">
                ...
                <p>${difficultyTemplate(recipe.rating)}
